--This is the basic World with nothing more 
--The only difficult is the speed that become faster and faster
...
function isGameEnd()
	...
	if enemy.finishGame() or (playerPoints==0 and selectedLevel==15) then
		scene.goToTheEnd()
