...
local shipObject=graphics.newImageSheet(path.."shipEnemyChristmas.png", sheetShips)
local enemyGroup
--enemies's Ship
local topEnemy
local rightEnemy
...
function enemies.create(groupGraph, level, r, sD)
	...
	--Add physics body
	physics.addBody(topEnemy,"static", {bounce=level.bounceShip})
	physics.addBody(rightEnemy,"static", {bounce=level.bounceShip})
	physics.addBody(leftEnemy,"static",  {bounce=level.bounceShip})
end
